...
public class Tweet {
    ...
    private int retweetsCount; //_________
    private boolean isLikedByCurrentUser;
    private boolean isRetweetedByCurrentUser; //_________
    ...
    public void setRetweetsCount(int n) { retweetsCount = n; }

    public boolean isRetweetedByCurrentUser() { return isRetweetedByCurrentUser; }
    public void setRetweetedByCurrentUser(boolean b) { isRetweetedByCurrentUser = b; }
